...
# This is a modified version of train_passgpt from PassGPT at https://github.com/javirandor/passgpt/blob/main/src/train_passgpt.py
# Modification is that it takes a pre-trained model as input rather than randomily initializing a new one
# Mean to be used with a config file with the "model path" parameter such as tune.yaml
